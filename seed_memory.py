...
QA_PAIRS = [
    ...
    },
    {
        ...
        "sql": "SELECT first_name, last_name, city, gender FROM patients ORDER BY last_name, first_name",
    },
    {
        "question": "How many patients are from Mumbai?",
        "sql": "SELECT COUNT(*) AS patient_count FROM patients WHERE city = 'Mumbai'",
    },
    {
    ...
    {
        "question": "List patients who have visited more than 3 times",
    ...
    },
    {
        ...
        "sql": "SELECT d.name, d.specialization, COUNT(a.id) AS appointment_count FROM doctors d LEFT JOIN appointments a ON a.doctor_id = d.id GROUP BY d.id ORDER BY appointment_count DESC",
    },
    # ── Appointment queries ───────────────────────────────────────────────────
    {
